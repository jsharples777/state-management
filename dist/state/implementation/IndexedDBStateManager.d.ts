...
export declare class IndexedDBStateManager extends AbstractAsynchronousStateManager {
    ...
    addItemInCollectionUsingConfig(key: string, item: any): Promise<any>;
    addNewItemToCollection(key: string, item: any, keyField?: string): Promise<any>;
    removeItemInCollectionUsingConfig(key: string, item: any): Promise<any>;
    removeItemFromCollection(key: string, item: any, keyField?: string): Promise<any>;
    updateItemInCollectionUsingConfig(key: string, item: any): Promise<any>;
    updateItemInCollection(key: string, item: any, keyField?: string): Promise<any>;
    setStateByName(name: string, stateObjectForName: any, informListeners: boolean): void;
    getCollectionUsingConfig(key: string): Promise<any>;
    ...
    findItemInCollectionUsingConfig(key: string, item: any): Promise<any>;
    findItemInCollection(key: string, item: any, keyField?: string): Promise<any>;
    getKeyFieldForKey(key: string): string;
    ...
    protected callbackForFindItem(data: any, associatedStateName: string): void;
